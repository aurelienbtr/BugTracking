insert into Developpeur (idDev,name, avatar) values (1,'aurelien','terre');
insert into Developpeur (idDev,name, avatar) values (2,'sofiane','lune');
insert into Developpeur (idDev,name, avatar) values (3,'emilie','jupiter');
